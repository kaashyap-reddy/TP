...
export const ADMIN_NAV_ITEMS: NavItem<AdminTabId>[] = [
  ...
  { tabId: 'reports', label: 'Reports', iconPath: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { tabId: 'logs', label: 'Audit Logs', iconPath: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' }
];
...
export const FACILITATOR_NAV_ITEMS: NavItem<FacilitatorTabId>[] = [
  ...
  { tabId: 'batches', label: 'Batches', iconPath: BATCHES_ICON },
  { tabId: 'assignments', label: 'Assignments', iconPath: ASSIGNMENTS_ICON },
  { tabId: 'sessions', label: 'Sessions & Calendar', iconPath: SESSIONS_CALENDAR_ICON },
  { tabId: 'resources', label: 'Resource Library', iconPath: RESOURCES_ICON },
  { tabId: 'announcements', label: 'Announcements', iconPath: ANNOUNCEMENTS_ICON },
  {
    tabId: 'feedback',
...
export const TRAINEE_NAV_ITEMS: NavItem<TraineeTabId>[] = [
  ...
  { tabId: 'batches', label: 'My Batch', iconPath: BATCHES_ICON },
  { tabId: 'assignments', label: 'Assignments', iconPath: ASSIGNMENTS_ICON },
  { tabId: 'sessions', label: 'Sessions & Calendar', iconPath: SESSIONS_CALENDAR_ICON },
  { tabId: 'resources', label: 'Learning Repository', iconPath: RESOURCES_ICON },
  { tabId: 'announcements', label: 'Announcements', iconPath: ANNOUNCEMENTS_ICON },
  {
    tabId: 'grades',
